...
- Target screen analysis could capture peaks with low intensity
...
- Step 1: reduce the numbers of peaks
  ...
  - remove redundant isotope, adducts, multi-chargers

- Step 2: MS/MS annotation

  - increase the sensitivity of untargeted analysis
