...
## Don't Panic
```{r echo=FALSE,out.width='72%', fig.cap='When you need to repeat your work ...'}
...
```{r bem,echo=FALSE,out.width='90%'}
knitr::include_graphics('https://yufree.github.io/presentation/figure/bem.png')
```

.half[
```{r beref,results = 'asis'}
doi <- c('10.18637/jss.v051.i10')
...
> You will never know each magic detail of each operator nn a certain day, even you did the experiment
...
- ### Those models would be overfitted
