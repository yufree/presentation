---
title: "科研用开源数据分析平台的搭建与部署——以xcmsrocker为例"
author: "于淼"
date: "2022-11-20"
output:
...
```{r echo=FALSE,fig.cap="Growth in Figshare, Dryad, Dataverse, Mendeley Data, Open Science Framework and Vivli DOIs in the published literature (2011-2021)",out.width = "800px"}
