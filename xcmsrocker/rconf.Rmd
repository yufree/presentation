...
```{r echo=FALSE,out.width='100%', fig.cap='Paper method v.s. Practical method in Metabolomics'}
...
```{r echo=FALSE,out.width = "800px"}
knitr::include_graphics('https://yufree.github.io/presentation/figure/pmdda.gif')
```
...
## http://yufree.github.io/presentation/xcmsrocker/rconf.html