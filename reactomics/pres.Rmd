...
- Dynamic mass pairs scenario 1: one of the paired peaks is stable across samples
- For example, [A,B], [C,D], [E,F] and [G,H] are involved in the same PMD:
...
- [A,B] and [G,H] are dynamic mass pairs with the same initial responds, rsd cutoff 30%
- [B,H] can be used to quantify certain reactions
- reaction amounts for the sum of B (50,500) and H(100,200) are [150,700] for group I and group II
...
- Dynamic mass pairs scenario 2: none of the paired peaks is stable across samples
- For example, [A,B], [C,D], [E,F] and [G,H] are involved in the same PMD:
...
- Combine static and dynamic mass pairs by normalization
- For example, [A,B], [C,D], [E,F] and [G,H] are involved in the same PMD:
...
- Normalization by the minimized intensity of [A,C,E,F] or [B,D,F,H], then quantify certain reactions on [B,D,F,H] or [A,C,E,F]
- Normalization on [A,C,E,F], Group I has [0.5, 0.5, 1.3, 1] for [B,D,F,H], Group II has [0.5, 9.5, 1.3, 2] for [B,D,F,H], reaction amounts are [3.3, 13.3] for group I and group II
