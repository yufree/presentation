...
- For CAMERA/RAMclust, peaks with highest intensity from pcgroup were selected as independant peaks
...
colnames(comp) <- c('Independant peaks','Target compounds found')
...
- 7 could be found by profinder untarget analysis 6628 features
...
- Targeted analysis could capture peaks with low intensity

- Untergeted analysis would loss sensitivity to captuer all peaks 

- Send unknown while independant peaks for MS/MS
...
- T3DB Endogenous (255) vs Exogenous (3422)

- Select a mixture of compounds

- Use high frenqency PMDs

```{r echo=FALSE,out.width = "500px"}
knitr::include_graphics("https://yufree.github.io/presentation/figure/t3db.png")
```
