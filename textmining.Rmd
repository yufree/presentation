...
![](https://yufree.github.io/presentation/pdpi.png)
...
Source Code is [**here**](https://github.com/yufree/presentation/blob/gh-pages/textmining.Rmd)
...
```{r QRcode}
par(mar=c(0,0,0,0))
image(qrencode_raster("https://yufree.github.io/presentation/textmining.html"), 
