...
```{r echo=FALSE,out.width='90%'}
knitr::include_graphics('https://raw.githubusercontent.com/yufree/presentation/master/static/figure/githubreg2.png')
```
...
```{r echo=FALSE,out.width='90%'}
knitr::include_graphics('https://raw.githubusercontent.com/yufree/presentation/master/static/figure/cosguide.png')
```
...
```{r echo=FALSE,out.width='90%'}
knitr::include_graphics('https://raw.githubusercontent.com/yufree/presentation/master/static/figure/monthly.png')
```
...
```{r echo=FALSE,out.width='90%'}
knitr::include_graphics('https://raw.githubusercontent.com/yufree/yufree.cn/master/static/figure/openreview.png')
```
