...
knitr::include_graphics('https://yufree.github.io/presentation/figure/githubreg2.png')
```
...
```{r echo=FALSE,out.width='70%'}
knitr::include_graphics('https://yufree.github.io/presentation/figure/cosguide.png')
```
...
```{r echo=FALSE,out.width='70%'}
knitr::include_graphics('https://yufree.github.io/presentation/figure/monthly.png')
```
...
knitr::include_graphics('https://yufree.github.io/presentation/figure/openreview.png')
```
